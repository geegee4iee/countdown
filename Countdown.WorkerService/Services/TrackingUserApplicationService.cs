...
{
    public class TrackingUserApplicationService : BackgroundService
    {
        ILogger<TrackingUserApplicationService> _logger;
        ...
        public TrackingUserApplicationService(ILogger<TrackingUserApplicationService> logger, IAppUsageRecordRepository repository, IAppUsageRecordRepository backupRepository)
        {
        ...
        private void PersistentRecords(object state)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error when persisting data");
